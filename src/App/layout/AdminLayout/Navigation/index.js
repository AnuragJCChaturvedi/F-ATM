...
const mapStateToProps = (state) => {
  return {
    ...
    preLayout: state.properties.preLayout,
    collapseMenu: state.properties.collapseMenu,
    layoutType: state.properties.layoutType,
    navBackColor: state.properties.navBackColor,
    navBackImage: state.properties.navBackImage,
    navIconColor: state.properties.navIconColor,
    navBrandColor: state.properties.navBrandColor,
    layout6Background: state.properties.layout6Background,
    layout6BackSize: state.properties.layout6BackSize,
    rtlLayout: state.properties.rtlLayout,
    navFixedLayout: state.properties.navFixedLayout,
    boxLayout: state.properties.boxLayout,
    navDropdownIcon: state.properties.navDropdownIcon,
    navListIcon: state.properties.navListIcon,
    navActiveListColor: state.properties.navActiveListColor,
    navListTitleColor: state.properties.navListTitleColor,
    navListTitleHide: state.properties.navListTitleHide,
  };
};
